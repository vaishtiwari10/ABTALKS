...
> After training, models can be exported and shared via a unique URL (e.g., `https://teachablemachine.withgoogle.com/models/<model-id>`). See the export section below.
